        ...
        <div className="layout-topbar">
            <Link to="/">
                <div className="cursor-pointer min-w-max flex align-items-end">
                    ...
                    <i className="pi pi-home" style={{ fontSize: '1.5rem' }}></i>  Government-software-license-records
                    </h3>
                </div>
            </Link>
            ...
            <ul className={'layout-topbar-menu lg:flex origin-top' + (props.mobileTopbarMenuActive ? ' layout-topbar-menu-mobile-active' : '')}>
                {props.onSettings ? (
                    <li>
            ...
            {props.isLoggedIn ? (
                <Button className="p-button-rounded p-button-outlined ml-3" style={{ zIndex: 20 }} icon="pi pi-user" label={props.user?.email} onClick={showMenu} aria-controls="user-popup-menu" aria-haspopup />
            ) : (
